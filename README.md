...
`psp.create` | Configure PodSecurityPolicies in Kubernetes installations which have enabled it. policy/v1beta1 PodSecurityPolicy is deprecated and unavailable in v1.25+. | false
